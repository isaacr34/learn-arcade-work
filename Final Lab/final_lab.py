...
class MyWindow(arcade.Window):
    ...
    def setup(self):
        ...
        # Set up the player
        self.player_sprite = arcade.Sprite("character_robot_idle.png", SPRITE_SCALING/2)
        ...
        map_array = get_map("platformer_map._Solid.csv")
        ...
        for row_index in range(len(map_array)):
            for column_index in range(len(map_array[row_index])):
                ...
                if item == 0:
                    ...
                    wall = arcade.Sprite("platformPack_tile043.png", SPRITE_SCALING)
                elif item == 3:
                    wall = arcade.Sprite("platformPack_tile047.png", SPRITE_SCALING)
                elif item == 4:
                    wall = arcade.Sprite("platformPack_tile013.png", SPRITE_SCALING)
                elif item == 5:
                    wall = arcade.Sprite("platformPack_tile016.png", SPRITE_SCALING)
                elif item == 6:
                    wall = arcade.Sprite("platformPack_tile037.png", SPRITE_SCALING)
                elif item == 7:
